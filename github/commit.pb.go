...
type CommitFileDetail struct {
	...
	Size_      int32                     `protobuf:"varint,12,opt,name=size,proto3" json:"size,omitempty"`
...
func (m *CommitFileDetail) MarshalTo(data []byte) (int, error) {
	...
	if m.Size_ != 0 {
		data[i] = 0x60
		i++
		i = encodeVarintCommit(data, i, uint64(m.Size_))
	}
	if m.Additions != 0 {
		data[i] = 0x68
		i++
...
var fileDescriptorCommit = []byte{
	...
	,
}
