...
func (m *GistFile) MarshalTo(data []byte) (int, error) {
	...
	if m.Size_ != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintGistEvent(data, i, uint64(m.Size_))
	}
	if len(m.RawUrl) > 0 {
		data[i] = 0x12
		i++
...
func (m *GistFile) Size() (n int) {
	...
	_ = l
	if m.Size_ != 0 {
		n += 1 + sovGistEvent(uint64(m.Size_))
	}
	l = len(m.RawUrl)
	if l > 0 {
...
var fileDescriptorGistEvent = []byte{
	...
	,
}
